...
class Uslugi(models.Model):
    ...
    name = models.CharField(max_length=200, help_text='заголовок для отображения на сайте до 200 символов',
                            verbose_name='Название страницы')
    minidescription = models.CharField(max_length=200, blank=True,
                                       help_text='текстовое описание под заголовком страницы, до 200 символов',
                                       verbose_name='Текстовое описание')
    uslugiimg = models.ImageField(blank=True, upload_to='contact/',
...
class Detailusluga(models.Model):
...
class Document(models.Model):
    materal = models.ForeignKey(Detailusluga,
