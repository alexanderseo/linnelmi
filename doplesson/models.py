...
class Doplesson(models.Model):
    ...
    class Meta:
        verbose_name = 'Дополнительные заняти: общая информация на странице'
        verbose_name_plural = 'Допзанятия: общая информация на странице'

    def __str__(self):
        return self.name


class Detailesson(models.Model):
    ...
    class Meta:
        verbose_name = 'Допзанятия - отдельная страница'
        verbose_name_plural = 'Допзанятия - отдельная страница'
...
class Document(models.Model):
    materal = models.ForeignKey(Detailesson,
